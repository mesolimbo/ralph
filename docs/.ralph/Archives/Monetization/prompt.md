...
Begin by breaking down your goal into granular, actionable tasks. Make sure you keep the plan as simple as possible while still satisfying your goal. IMPORTANT: You and your agents should avoid over-engineering, keep it simple. Avoid monolithic tasks, opt instead for a set of smaller SMART subtasks.
